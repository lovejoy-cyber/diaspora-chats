...
const ROLES = [
  { value: "student",    label: "🎓 Student",              desc: "I am a foreign student studying abroad" },
  { value: "sender",     label: "💸 Transfer Agent",        desc: "I help the community send or receive money" },
  { value: "ambassador", label: "🤝 Community Ambassador",  desc: "I represent a national community group" },
];
